      ...
      <div className="max-w-5xl mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          <a 
            ...
            className="text-textMuted hover:text-whatsapp transition-colors hidden sm:flex items-center"
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer" 
            className="text-textMuted hover:text-primary transition-colors hidden sm:flex items-center"
